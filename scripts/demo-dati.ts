...
const ARTISTI: Demo[] = [
  ...
  {
    nome: "Giulia Mainardi",
    citta: "milano",
    discipline: ["fotografi"],
    foto: true,
  ...
  {
    nome: "Le Sorelle Vento",
    citta: "milano",
    discipline: ["band", "cantanti"],
  ...
  },
  {
    nome: "Samuele Ferri",
    citta: "milano",
    discipline: ["dj", "musicisti"],
    foto: true,
    headline: "DJ e produttore, techno melodica.",
    lavori: ["audio", "audio", "audio"],
  },
  {
    nome: "Collettivo Bruma",
    citta: "milano",
    discipline: ["illustratori"],
  ...
  },
  {
    nome: "Fabio Deiana",
    citta: "roma",
    discipline: ["fotografi", "videomaker"],
  ...
  {
    nome: "Compagnia Terzo Piano",
    citta: "bologna",
    discipline: ["attori", "ballerini"],
  ...
  },
  {
    nome: "Marta Cilento",
    citta: "napoli",
    discipline: ["illustratori", "fotografi"],
    foto: true,
...
const INGAGGI = [
  {
    titolo: "Duo acustico per aperitivo in cortile",
    citta: "milano",
    categoria: "LIVE",
    giorni: 6,
    pagato: true,
    min: 180,
    max: 220,
    locale: "Cascina Nascosta",
    descrizione:
      "Due ore di musica di sottofondo per l'aperitivo estivo in cortile. Repertorio jazz, bossa o cantautorato. Impianto voce e due DI a disposizione, niente batteria.",
  },
  {
    titolo: "Fotografo per press kit di band emergente",
    citta: "milano",
    categoria: "CASTING",
    giorni: 12,
    pagato: true,
    min: 300,
    max: 500,
    locale: "Studio Lambrate",
    descrizione:
      "Cerchiamo un fotografo per il press kit di un quintetto: ritratti di gruppo e singoli, mezza giornata in studio più un'ora in esterni. Consegna di dieci scatti ritoccati.",
  },
  {
    titolo: "Ballerini per videoclip in bianco e nero",
    citta: "milano",
    categoria: "CASTING",
    giorni: 18,
    pagato: true,
    ...
    locale: "Ex Fornace",
    descrizione:
      "Due giornate di riprese per un videoclip. Cerchiamo quattro danzatori con esperienza in contemporanea. Coreografia già scritta, due giorni di prove pagati a parte.",
  },
  {
    titolo: "Attori per lettura scenica in biblioteca",
    citta: "roma",
    categoria: "CASTING",
    giorni: 26,
    pagato: true,
    min: 120,
    locale: "Biblioteca Rispoli",
    descrizione:
      "Lettura scenica di racconti del Novecento italiano, tre serate. Cerchiamo due attori. Due prove di due ore, compenso a serata.",
  },
  {
    titolo: "Workshop di illustrazione per manifesti",
    citta: "bologna",
    categoria: "WORKSHOP",
    giorni: 40,
    pagato: true,
    ...
    locale: "Serra Madre",
    descrizione:
      "Due giornate di laboratorio sulla serigrafia applicata ai manifesti di concerti. Cerchiamo un docente con pratica di stampa. Materiali forniti.",
  },
  {
    titolo: "Mandolino e voce per matrimonio sul golfo",
    citta: "napoli",
    categoria: "LIVE",
    giorni: 55,
    pagato: true,
    min: 500,
    max: 700,
    locale: "Villa Nausicaa",
    descrizione:
      "Cerimonia e aperitivo, circa tre ore complessive. Repertorio classico napoletano. Impianto fornito dal service della villa.",
  },
  {
    titolo: "Comico per serata di apertura",
    citta: "torino",
    categoria: "LIVE",
    giorni: 11,
    pagato: true,
    ...
    locale: "Blah Blah",
    descrizione:
      "Venti minuti di apertura prima del concerto principale. Cerchiamo stand-up, materiale già rodato. Pubblico fra i venticinque e i quarant'anni.",
  },
  {
    titolo: "Videomaker per riprese multicamera di un live",
    citta: "roma",
    categoria: "CASTING",
    giorni: 30,
    pagato: true,
    ...
    locale: "Monk",
    descrizione:
      "Concerto di un'ora e mezza, tre camere. Cerchiamo un videomaker che gestisca anche il montaggio. Audio fornito dal fonico di sala, multitraccia.",
  },
];
  ...
  const citta = new Map(
    (
      await prisma.city.findMany({
        select: { slug: true, name: true, region: true, latitude: true, longitude: true },
      })
    ).map((c) => [c.slug, c])
  );

  const mancanti = [
    ...new Set([...ARTISTI.map((a) => a.citta), ...INGAGGI.map((e) => e.citta)]),
  ].filter((s) => !citta.has(s));
    ...
    for (let k = 0; k < 3; k++) {
      ...
      await prisma.participation.upsert({
        ...
        create: {
          ...
          message:
            k === 0 ? "Disponibile per quella data, ho già suonato in uno spazio simile." : null,
        },
      });
    }
  }
