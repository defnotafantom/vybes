...
- Name: percorso-critico.spec.ts >> ritorno alla destinazione dopo il login >> la destinazione conserva la query anche con più parametri
- Location: tests\e2e\percorso-critico.spec.ts:39:7
